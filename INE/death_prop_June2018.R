...
bd<-"C:/Users/Denise Laroze P/Dropbox/PMCL/Data"
...
pd$pm_39_2015<-s_pop-pd$s.39
pd$pm_49_2015<-s_pop-pd$s.49
pd$pm_59_2015<-s_pop-pd$s.59
pd$pm_64_2015<-s_pop-pd$s.64
pd$pm_69_2015<-s_pop-pd$s.69
pd$pm_74_2015<-s_pop-pd$s.74



pd<-pd[, c("code", "pm_39_2015", "pm_49_2015", "pm_59_2015", "pm_64_2015", "pm_69_2015", "pm_74_2015" )]


write.csv(pd, file = "INE/pm2015.csv")
save(pd, file="INE/pm2015.RData")
